...
Accidents dropped in 2020, which isn't surprising, considering that drivership would naturally drop during a time that people aren't commuting to the workplace. 2021 saw some of the highest and lowest days for accidents; what's up with that? It definitely seems that accidents increased as drivers got back on the streets post-pandemic.
...
Friday has the highest number, which makes sense, since there are likely the most people on the road -- daytime commutes to and from work cross transition into weekend night time risks of drunk driving. Monday, Tuesday and Wednesday all seem to be about equally low, but Monday has some particularly low outliers. Monday could be the lowest because of a lack of drunk driving incidents, but I'm sure there are more contributing factors than that.
...
The day with the highest number of accidents was October 29, 2021. I found an photo story from NBC4 Washington about widespread flooding in Maryland, with 16 photos showing how the area was affected. Accidents definitely spiked due to the heavy rain and severe flooding. A story like the NBC4 coverage that focused on road incidents could include photographs of people trying to drive in torrential rain or through flooded streets.
...
The day with the second highest incidents overall, Saturday, May 1, is only #8 in terms of its z-score, which puts into perspective just how many incidents there are on Saturdays compared to other days; except Friday, since Friday, October 29 tops both lists.
...
October has the highest average number of accidents, while January has the lowest. October could have the highest for a number of reasons; Fall in Maryland often comes with rain, and driving on wet leaves can be very dangerous. Fall means shorter days and more driving in the dark, but that wouldn't explain why averages go down again in November, nor why accidents would be so low in January. Would accidents drop due to winter break and holidays? Why do accidents seem to climb consistently as a year progresses? I honestly have very few answers, this is really confounding me and demonstrates why civil engineering is such a complex practice. It combines sociology and psychology with hard science like physics and engineering.
...
Almost all of them are on Fridays or weekends, with the exception of Monday, November 29. All of the positive outliers are on Fridays or Saturdays specifically.
...
Car accidents spike on Fridays and Saturdays

Of the top 10 days of 2021 with the most car accidents in Prince George's County, all were a Friday or a Saturday, according to new statistics by the Maryland Department of Transportation. Fridays and Saturdays saw a significantly higher average number of accidents and greater outliers. Average incidents on Sundays were higher than weekdays but lower than Fridays and Saturdays.

For this story, I would look to interview civil engineers for insight on when driving is most dangerous, at least one MDOT spokesperson to inquire on how they gather their statistics and the ways the implement their findings, and local or state police on how they respond to car accidents.
