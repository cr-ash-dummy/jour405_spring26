...
There doesn't seem to be any correlation between fouls and match result. The correlation calculation is extremely low, less than 0.02, and the scatterplot line is almost flat.

### Task 7: Choose another variable and repeat the steps in Tasks 4 and 5, then describe the result.
...
```
### There is a positive correlation between corner kicks and match result. The correlation calculation came back with almost 0.4 and the scatterplot draws an upward line.
