...
The weights range from ~0.25 to ~2.6.

2. What does it mean when a respondent has a weight of 0.23? What about 3.04?
A respondent with a weight of 0.23 is overrepresented, counting as less than one person. A respondent with a weight of 3.04 is underrepresented, counting as more than one person.

3. Why might some respondents be weighted more heavily than others?
Some respondents might be weighted heavily because they're from a demographic background that's less represented in the survey.
...
Rarely/never has the biggest difference between weighted and unweighted.

2. How might these differences affect reporting on likely voter turnout?
People who don't vote are hard to reach (since they're less likely to vote in elections or participate in surveys) so we often don't know why they abstain or why they do vote if they do.
...
People who don't vote probably didn't respond to the survey. They're not interested in being civically active.
