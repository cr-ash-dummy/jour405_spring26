...
Maryland is in the 95th percentile for aces in volleyball games, meaning we scored more or the same amount of aces as 95% of other teams, and 5% of teams scored more than us. When ranked solely by number of aces, Maryland is #17 overall. In volleyball, an ace is a serve that immediately scores, meaning the other team doesn't return it. Getting an ace means the opposing team can't defend against you. So Maryland must have a strong offense that's good at cracking opposing defense.
